...
$sql_items = "SELECT *, fridgelists.img_url AS image, fridgelists.fridgelist_name AS name, mastersheet.fridgelist_id AS id
    FROM mastersheet
    LEFT JOIN fridgelists
    ON mastersheet.fridgelist_id=fridgelists.fridgelist_id 
    WHERE mastersheet.user_id=$user_id AND category_id=" .$_POST['category']. ";";
